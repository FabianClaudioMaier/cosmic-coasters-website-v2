    ...
    emailjs
     ...
     'template_h7sehoe',
      ...
      .then(
        () => {
          setLoading(false);
          alert("Thank you. Cosmic coasters will get back to you as soon as possible.");
  ...
  return (
    ...
    >
      <motion.div
        ...
        className='flex-[0.75] bg-[#232631] p-8 rounded-2xl'
      >
        ...
        >
          ...
          <button
            type='submit'
            className='bg-[#121212] py-3 px-8 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-primary'
          >
